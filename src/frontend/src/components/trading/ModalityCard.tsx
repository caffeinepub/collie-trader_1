...
import { Clock, TrendingUp, TrendingDown, Zap, X, Brain, ChevronDown, ChevronUp, Scan, Clipboard } from 'lucide-react';
...
import { copyTradeSetup } from '../../utils/copySetup';
            ...
            <div className="flex items-center justify-between">
              <div>
                <button
                  ...
                  className="text-sm font-bold terminal-text hover:text-primary transition-colors cursor-pointer"
                >
                  {trade.symbol}
                </button>
                ...
                <CollapsibleContent>
                  <div className="mt-1.5 space-y-1 pl-4 border-l border-primary/20">
                    {trade.topFactors.slice(0, 3).map((factor, i) => (
                      <div key={`factor-${i}`} className="flex items-start gap-1.5">
